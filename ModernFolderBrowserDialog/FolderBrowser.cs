...
using System.IO;
using ModernFolderBrowserDialog.Interop;

namespace ModernFolderBrowserDialog
{
    /// <summary>
    ...
    public sealed class FolderBrowser : CommonDialog
    {
        ...
        protected override bool RunDialog(IntPtr hwndOwner)
        {
            ...
            ModernFolderBrowserDialog.Interop.IFileDialog dialog = null;
            try
            {
                dialog = new ModernFolderBrowserDialog.Interop.NativeFileOpenDialog();
        ...
        private void SetDialogProperties(ModernFolderBrowserDialog.Interop.IFileDialog dialog)
        {
            // Description
            if (!string.IsNullOrEmpty(_description))
            {
                ...
                {
                    ModernFolderBrowserDialog.Interop.IFileDialogCustomize customize = (ModernFolderBrowserDialog.Interop.IFileDialogCustomize)dialog;
        ...
        private void GetResult(ModernFolderBrowserDialog.Interop.IFileDialog dialog)
        {
            ModernFolderBrowserDialog.Interop.IShellItem item;
